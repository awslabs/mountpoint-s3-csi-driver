...
EKSCTL_PATCH_AL2_SECURITY_UPDATE_FILE=${EKSCTL_PATCH_AL2_SECURITY_UPDATE_FILE:-${BASE_DIR}/eksctl-patch-al2-security-update.json}
if [[ "${AMI_FAMILY}" != "AmazonLinux2" ]]; then
    EKSCTL_PATCH_AL2_SECURITY_UPDATE_FILE=""
fi
