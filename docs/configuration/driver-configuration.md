...
| `s3CredentialSecret.name`                               | Name of the Kubernetes Secret containing AWS credentials (`key_id`, `access_key`, optionally `session_token`). You must create this secret manually. | `s3-secret`                                           | No                          |
